...
<div class="wrapper">
  <?php require_once $_SERVER['DOCUMENT_ROOT']."/virtual_enterprise/VirtualEnterprise/frontend/admin/pages/header.php"; ?>
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box box-info">
            <form action="php/dashboardMail.php" method="post">
